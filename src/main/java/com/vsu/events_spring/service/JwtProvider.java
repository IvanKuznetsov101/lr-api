...
public class JwtProvider {
    ...
    public JwtProvider(
            @Value("${events_spring.jwt.secret.access}") String jwtAccessSecret,
            @Value("${events_spring.jwt.secret.refresh}") String jwtRefreshSecret
    ) {
    ...
    public String generateAccessToken(@NonNull Profile user) {
        ...
        return Jwts.builder()
                ...
                .setId(user.getId_profile().toString())
                .setExpiration(accessExpiration)
                .signWith(jwtAccessSecret)
                .claim("firstName", user.getFull_name())
                .compact();
    }
