...
public class VisitorRepository {
    ...
    public Long create(Visitor visitor) {
        String sql = "INSERT INTO visitor (id_light_room, id_profile, visitor_start_time) VALUES (?, ?, ?) RETURNING id_visitor";
        Object[] params = new Object[]{visitor.getId_light_room(), visitor.getId_profile(), visitor.getVisitor_start_time()};
